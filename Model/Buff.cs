    ...
    internal class Buff
    {
        ...
        public static List<Buff> GetMerchantSkills()
        {
            List<Buff> skills = new List<Buff>
            {
                ...
                new Buff("Full Adrenaline", EffectStatusIDs.ADRENALINE2, Resources._4RTools.Icons.bs_adrenaline2),
        ...
        public static List<Buff> GetThiefSkills()
        {
            List<Buff> skills = new List<Buff>
            {
                ...
                new Buff("EDP", EffectStatusIDs.EDP, Resources._4RTools.Icons.asc_edp),
                ...
                new Buff("Enchant Poison", EffectStatusIDs.EFST_ENCHANTPOISON, Resources._4RTools.Icons.dancing_knife),
        ...
        public static List<Buff> GetTaekwonSkills()
        {
            List<Buff> skills = new List<Buff>
            {
                ...
                new Buff("Solar Protection", EffectStatusIDs.EFST_SUN_COMFORT, Resources._4RTools.Icons.SG_SUN_COMFORT),
                new Buff("Lunar Warmth", EffectStatusIDs.EFST_SG_MOON_WARM, Resources._4RTools.Icons.SG_MOON_WARM),
                new Buff("Lunar Protection", EffectStatusIDs.EFST_MOON_COMFORT, Resources._4RTools.Icons.SG_MOON_COMFORT),
                new Buff("Stellar Warmth", EffectStatusIDs.EFST_SG_STAR_WARM, Resources._4RTools.Icons.SG_STAR_WARM),
                new Buff("Stellar Protection", EffectStatusIDs.EFST_STAR_COMFORT, Resources._4RTools.Icons.SG_STAR_COMFORT),
        ...
        public static List<Buff> GetElementalsBuffs()
        {
            List<Buff> skills = new List<Buff>
            {
                ...
                new Buff("Fire Converter", EffectStatusIDs.PROPERTYFIRE, Resources._4RTools.Icons.ele_fire_converter),
                new Buff("Wind Converter", EffectStatusIDs.PROPERTYWIND, Resources._4RTools.Icons.ele_wind_converter),
                new Buff("Earth Converter", EffectStatusIDs.PROPERTYGROUND, Resources._4RTools.Icons.ele_earth_converter),
                new Buff("Water Converter", EffectStatusIDs.PROPERTYWATER, Resources._4RTools.Icons.ele_water_converter),
                new Buff("Aspersio Scroll", EffectStatusIDs.ASPERSIO, Resources._4RTools.Icons.ele_holy_converter),
                new Buff("Ghost Converter", EffectStatusIDs.PROPERTYTELEKINESIS, Resources._4RTools.Icons.ele_ghost_converter),
        ...
        public static List<Buff> GetScrollBuffs()
        {
            List<Buff> skills = new List<Buff>
            {
                ...
                new Buff("Agility Scroll", EffectStatusIDs.INC_AGI, Resources._4RTools.Icons.al_incagi1),
                new Buff("Bless Scroll", EffectStatusIDs.BLESSING, Resources._4RTools.Icons.al_blessing1),
                new Buff("FCP Scroll", EffectStatusIDs.PROTECTARMOR, Resources._4RTools.Icons.cr_fullprotection),
        ...
        public static List<Buff> GetETCBuffs()
        {
            List<Buff> skills = new List<Buff>
            {
                ...
                new Buff("Frost Giant", EffectStatusIDs.EFST_GVG_GIANT, Resources._4RTools.Icons.frost_giant_blood),
                new Buff("Golem's Core", EffectStatusIDs.EFST_GVG_GOLEM, Resources._4RTools.Icons.golem_stone),
        ...
        public static List<Buff> GetEXPBuffs()
        {
            List<Buff> skills = new List<Buff>
            {
                ...
                new Buff("Battle Manual", EffectStatusIDs.CASH_PLUSEXP, Resources._4RTools.Icons.combat_manual_base),
                new Buff("Job Battle Manual", EffectStatusIDs.CASH_PLUSECLASSXP, Resources._4RTools.Icons.combat_manual_class),
            };
